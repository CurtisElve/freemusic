...
<div align="center">
  <video src="https://github.com/user-attachments/assets/f0cc0e8f-cb39-48b8-9ee4-34d705812d02" width="100%" controls>
...
- **Download:** Uses fetched metadata from Spotify to query YouTube and download audio with `yt-dlp`. FFMPEG converts the audio to MP3.
